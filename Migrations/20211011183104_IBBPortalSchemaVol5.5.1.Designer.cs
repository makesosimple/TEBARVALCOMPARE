...
namespace IBBPortal.Migrations
{
    ...
    [Migration("20211011183104_IBBPortalSchemaVol5.5.1")]
    partial class IBBPortalSchemaVol551
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IBBPortal.Models.Project", b =>
                {
                    ...
                    b.Property<string>("ProjectProductionStatusDescription")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");

                    b.Property<int?>("ProjectProductionStatusID")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RequestingAuthorityDescription")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");

                    b.Property<int?>("RequestingAuthorityID")
                        .HasColumnType("int");

                    b.Property<int?>("RequestingDepartmentID")
                        .HasColumnType("int");

                    b.Property<DateTime?>("RespDepartmentTransferDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ProjectProductionStatusID");
                    ...
                    b.HasIndex("RequestingAuthorityID");
            ...
            modelBuilder.Entity("IBBPortal.Models.ProjectField", b =>
                {
                    ...
                    b.Property<Polygon>("ProjectPolygon")
                        .HasColumnType("geography");
            ...
            modelBuilder.Entity("IBBPortal.Models.ProjectProduction", b =>
                {
                    ...
                    b.Property<DateTime?>("ApproximateCostDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal?>("ContractIncrementCost")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int?>("MonetaryCompletionRatio")
                        .HasColumnType("int");

                    b.Property<DateTime?>("OpeningDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("PhysicalCompletionRatio")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("TotalProgressPaymentCost")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("IBBPortal.Models.ProjectSubfunctionFeature", b =>
                {
                    b.Property<int>("ProjectSubfunctionFeatureID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("SubfunctionFeatureValue")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("SubfunctionFeatureValueDescription")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasKey("ProjectSubfunctionFeatureID");

                    b.HasIndex("ProjectID");

                    b.HasIndex("SubfunctionFeatureID");

                    b.HasIndex("SubfunctionID");

                    b.HasIndex("UserID");

                    b.ToTable("ProjectSubfunctionFeature");
                });
            ...
            modelBuilder.Entity("IBBPortal.Models.ProjectType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IBBPortal.Models.RelProjectPropertyStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RelProjectPropertyStatus");
                });
            ...
            modelBuilder.Entity("IBBPortal.Models.ServiceArea", b =>
                {
                    ...
                    b.Property<int?>("ServiceAreaLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IBBPortal.Models.TransactionMessages", b =>
                {
                    ...
                    b.Property<string>("TransactionMessageSlug")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IBBPortal.Models.File", b =>
                {
                    b.HasOne("IBBPortal.Models.FileCategory", "FileCategory")
                        .WithMany()
                        .HasForeignKey("FileCategoryID");

                    b.HasOne("IBBPortal.Models.ProjectBidding", "ProjectBidding")
                        .WithMany()
                        .HasForeignKey("ProjectBiddingID");
            ...
            modelBuilder.Entity("IBBPortal.Models.Project", b =>
                {
                    ...
                    b.HasOne("IBBPortal.Models.ProjectStatus", "ProjectProductionStatus")
                        .WithMany()
                        .HasForeignKey("ProjectProductionStatusID");
                    ...
                    b.HasOne("IBBPortal.Models.ProjectType", "ProjectType")
                        .WithMany()
                        .HasForeignKey("ProjectTypeID");

                    b.HasOne("IBBPortal.Models.Authority", "RequestingAuthority")
                        .WithMany()
                        .HasForeignKey("RequestingAuthorityID");
                    ...
                    b.Navigation("ProjectProductionStatus");
                    ...
                    b.Navigation("RequestingAuthority");
            ...
            modelBuilder.Entity("IBBPortal.Models.ProjectPermission", b =>
                {
                    b.HasOne("IBBPortal.Models.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("IBBPortal.Models.ProjectSubfunctionFeature", b =>
                {
                    ...
                    b.HasOne("IBBPortal.Models.SubfunctionFeature", "SubfunctionFeature")
                        .WithMany()
                        .HasForeignKey("SubfunctionFeatureID");
                    ...
                    b.Navigation("SubfunctionFeature");
            ...
            modelBuilder.Entity("IBBPortal.Models.RelProjectPropertyStatus", b =>
                {
                    b.HasOne("IBBPortal.Models.ProjectExpropriation", "ProjectExpropriation")
                        .WithMany()
                        .HasForeignKey("ProjectExpropriationID");

                    b.HasOne("IBBPortal.Models.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectID");

                    b.HasOne("IBBPortal.Models.PropertyStatus", "PropertyStatus")
                        .WithMany()
                        .HasForeignKey("PropertyStatusID");

                    b.Navigation("Project");

                    b.Navigation("ProjectExpropriation");
