...
function buildMap() {
    ...
    const selectDepartment = $("#selectDistrict").val();
    const selectProjectOwner = $("#selectProjectOwner").val();
    const selectProjectStatus = $("#selectProjectStatus").val();
    ...
    var queryString = "projectTitle=" + projectTitle;
    queryString += "&selectDistrict=" + selectDistrict;
    queryString += "&selectDepartment=" + selectDepartment;
    queryString += "&selectProjectStatus=" + selectProjectStatus;
    ...
    markers = [];
    $('.loadingDiv').show();
    $.getJSON("/Project/MapDataExecutive/?" + queryString, function (json) {
...
$(document).ready(function () {
    ...
    $('#selectFunction').select2({
        ...
        language: "tr",
        ajax: {
            url: '/Subfunction/JsonSelectData',
            dataType: 'json',
            processResults: function (response) {
